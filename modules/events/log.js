...
module.exports.run = async function ({ api, event, Users, Threads }) {
  ...
  var formReport = "» TB اضافة / طرد «" +
    //"\n\n👨‍👩‍👧‍👧Box: " + nameThread +
    "\n\n✅ايدي الكروب: " + event.threadID +
    "\n🤷‍♀️الاجراء : {task}" +
    "\n🍳اسم الي طرد او ضاف البوت: " + nameUser +
    "\n📩ايدي الشخص: " + event.author +
    "\n\n⏰الوقت: " + time + "",
    task = "";
  switch (event.logMessageType) {
    ...
    case "log:subscribe": {
      if (event.logMessageData.addedParticipants.some(i => i.userFbId == botID)) task = "✅أضاف المستخدم البوت إلى مجموعة جديدة✅";
      break;
    }
