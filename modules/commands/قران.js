...
var min = Math.floor(Math.random() * 2);
  ...
  var money = data.money
   ...
   var callback = () => api.sendMessage({body: ,attachment: fs.createReadStream(dirname + "/cache//288.mp3")}, event.threadID, () => fs.unlinkSync(dirname + "/cache/288.mp3"), event.messageID); 
