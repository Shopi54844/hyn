module.exports.config = {
	...
	description: "نسبه الحب بينك وبين لشخص اللي تسويله تاك",
	commandCategory: "",
	usages: "الحب + tag\n او \n /الحب fake + tag "
};
...
if(!mentions1) {  
  ...
  else{return api.sendMessage(`===== HDSD =====\n\n/rela + tag\n OR \n /rela fake + tag`,event.threadID,event.messageID)};
};
...
//Chạy handle reply
return api.sendMessage(`❤️ nhập số tym của bạn ví dụ 8|8|8|8|8`, event.threadID, (err, info) => {
