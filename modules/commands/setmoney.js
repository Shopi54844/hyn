...
var mention = Object.keys(event.mentions)[0];
    ...
    var {body} = event;
			...
			var moneySet = content.substring(content.lastIndexOf(" ") + 1);
    			if (args[0]=='me'){
    			 return api.sendMessage(`تم اضافة ${moneySet} الى رصيد المستخدم bạn`, event.threadID, () => Currencies.increaseMoney(event.senderID, parseInt(moneySet)), event.messageID)	
			}
			else if(args[0]=="del"){
if (args[1] == 'me'){
