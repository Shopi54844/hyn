module.exports.config = {
 ...
 description: "تصمم غلاف بسيط وسريع",

 commandCategory: "💗𝗔𝗡𝗜𝗠𝗘💗",

 usages: "(ارقام بين الـ0 والـ3) . (ارقام بين الـ1 والـ3 ) . (نص) . (نص)",
...
module.exports.run = async ({ event, api, args }) => {
    ...
    if(!args[0]) return api.sendMessage('خطأ في بناء الجملة \n(ارقام بين الـ0 والـ3) . (ارقام بين الـ1 والـ3 ) . (نص) . (نص)', threadID, messageID);
