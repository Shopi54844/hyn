module.exports.config = {
    ...
    hasPermssion: 0,
    credits: "𝒍𝒊𝒏𝒖𝒙",
    description: "افتار انمي للاولاد",
...
"https://i.imgur.com/DKUxCGa.jpg",
    ...
    var callback = () => api.sendMessage({ body: `افتار انمي 🥶🤍،\nالمطور: 🧑‍💻⭐SMILE,`, attachment: fs.createReadStream(__dirname + "/cache/5.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/5.jpg"), event.messageID);
