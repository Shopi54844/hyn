...
ريم إسمي: ${global.config.BOTNAME}
...
✫شكرا على إستعمالي ${global.config.BOTNAME} بوت✅!,attachment: fs.createReadStream(dirname + "/cache/juswa.jpg")}, event.threadID, () => fs.unlinkSync(dirname + "/cache/juswa.jpg")); 
