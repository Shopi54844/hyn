...
module.exports.config = {
    ...
    hasPermssion: 0,
    credits: "D-Jukie",
    description: "نص مطاردة التقاط الصور على رسول الخاص بك!!!",
    ...
    switch (handleReply.type) {
        case "reply": {
            ...
            if (dapan.toLowerCase() == tukhoa) {
                ...
                var msg = {body: `${namePlayer.name} أجاب بشكل صحيح!\nإجابه: ${tukhoa}`, attachment: img_1}
                return api.sendMessage(msg, event.threadID, event.messageID)
            }
            else
            return api.sendMessage(`الجواب غير صحيح!!!`, event.threadID, event.messageID)
        }
    }
}
...
var img_as = [];        
        ...
        var msg = {body: `الرجاء الرد على هذه الرسالة للرد (${timeout}s)`, attachment: img_qs}
