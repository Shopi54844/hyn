module.exports.config = {
    ...
    hasPermssion: 0,
    credits: "Zera",
    description: "ينزل من الفيس - مينزل من الكروبات",
  commandCategory: "تنزيل من لفيس",
...
return api.sendMessage({body : `✅ تم التحميل ✅`, 
    attachment: fs.createReadStream(path1)}, event.threadID, () => fs.unlinkSync(path1),event.messageID);
    }; 
  }catch {return api.sendMessage(`غير قادر على تحميل الفيديو و, ربما اعدادات خصوصية الفيديو غير عامة`,event.threadID,event.messageID)}
  }