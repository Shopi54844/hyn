...
"https://i.postimg.cc/N0GwTBnG/photo-5384209807751363517-y.jpg",
	 ...
	 var callback = () => api.sendMessage({body:`🍒 أقتراحي لك : من اصل ${link.length} صورة`,attachment: fs.createReadStream(__dirname + "/cache/5.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/5.jpg"));	
